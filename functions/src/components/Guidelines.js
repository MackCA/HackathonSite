    ...
    return (
        <section className="section-rules">
          ...
          <div className="row">
            ...
            <div className="col span-1-of-4 box">
              <ion-icon name="microphone" className="icon-big"></ion-icon>
              <h3>Presentation</h3>
            ...
            <div className="col span-1-of-4 box">
              <ion-icon name="ribbon" className="icon-big"></ion-icon>
              <h3>Sweet victory</h3>
